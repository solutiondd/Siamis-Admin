        ...
        <div class="modal-box">
            ...
            <div class="py-4">
                <p class="text-base-content mb-4">
                    {{ t('academicCalendarModal.deleteConfirmText') }} <span class="font-bold text-error">{{ t('academicCalendarModal.yearText', { year }) }}</span> {{ t('academicCalendarModal.right') }}?
                </p>
            ...
            <div class="modal-action">
                ...
                <button type="button" class="btn btn-error text-white" @click="handleDelete" :disabled="loading">
                    ...
                    <span v-else>{{ t('academicCalendarModal.delete') }}</span>
                </button>
            </div>
        </div>
